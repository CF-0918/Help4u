      ...
      body: ListView(
        ...
        children: [
          ...
          serviceReminder != true
              ? Container(
                child: Text(
                  "You can set the reminder period when Service Reminder is enabled.",
                ),
              )
              : Container(
                decoration: BoxDecoration(
                ...
                child: Column(
                  children: [
                    ...
                    _radioTile(
                      ...
                      subtitle:
                          "You will receive a reminder 3 days before your service is due.",
                    ),
                    const Divider(height: 1, color: Colors.white12),
                    ...
                    _radioTile(
                      ...
                      title: "1 Day Onwards",
                      subtitle:
                          "You will receive a reminder 1 day before your service is due.",
                    ),
                  ],
                ),
              ),
